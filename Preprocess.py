...
def preprocess(imgOriginal):
    ...
    imgMaxContrastGray = maximizeContrast(
        imgGray
...
def maximizeContrast(imgGray):
    ...
    imgTopHat = cv2.morphologyEx(
        imgGray, cv2.MORPH_TOPHAT, structuringElement, iterations=10
    )  # nổi bật chi tiết sáng trong nền tối
    # cv2.imwrite("tophat.jpg",imgTopHat)
    imgBlackHat = cv2.morphologyEx(
        imgGray, cv2.MORPH_BLACKHAT, structuringElement, iterations=10
