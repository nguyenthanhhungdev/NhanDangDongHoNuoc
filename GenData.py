...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("QLTTN/training_chars.png")           # read in training numbers image
    ...
    intValidChars = [ord('0'), ord('1'), ord('2'), ord('3'), ord('4'), ord('5'), ord('6'), ord('7'), ord('8'), ord('9')] #Là mã ascii của mấy chữ này
    # print(intValidChars)
